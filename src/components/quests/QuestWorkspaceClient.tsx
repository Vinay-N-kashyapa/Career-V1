...
export default function QuestWorkspaceClient({ questId }: { questId: string }) {
  ...
  const { completedQuests, addCompletedQuest, pins, spendPins } = useCareerOS();
  const { user } = useAuth();
          ...
          <div style={{ background: 'var(--bg2)', border: '1.5px solid var(--border)', borderRadius: 20, padding: 20, display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              <button
                ...
                className="btn-primary"
                style={{ flex: 1, justifyContent: 'center', padding: 12, fontSize: 13, background: 'var(--coral)', border: '1px solid var(--coral)', boxShadow: '0 4px 12px rgba(220,38,38,0.2)' }}
              >
          ...
          <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 20, padding: 20, display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              <button
                onClick={handleVerifySolution}
                className="btn-primary"
                style={{ flex: 1, justifyContent: 'center', padding: 12, fontSize: 13 }}
              >
                Submit Assignment ✓
              </button>
              <button
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20, justifyContent: 'space-between' }}>
          ...
          <div style={{
            ...
            <button
              ...
              className="btn-primary"
              style={{ padding: '10px 24px', fontSize: 12.5, display: 'inline-flex', alignItems: 'center', gap: 6 }}
            >
              ✓ Complete Lesson
            </button>
          </div>
