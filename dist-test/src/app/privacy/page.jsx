        ...
        <div style={{
          ...
          <section style={{ display: 'flex', flexDirection: 'column', gap: '24px', fontSize: '14px', lineHeight: '1.6', color: 'var(--t2)' }}>
            ...
            <div>
              ...
              <p>
                If you have any questions or concerns regarding this Privacy Policy, please visit our <link_1.default href="/contact" style={{ color: 'var(--accent)', textDecoration: 'none' }}>Contact Page</link_1.default>.
              </p>
            </div>
          </section>
        </div>
