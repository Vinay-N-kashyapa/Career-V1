...
function AdminSettingsPage() {
    const [activeTab, setActiveTab] = (0, react_1.useState)('admin');
    return (<div style={{ maxWidth: 960, margin: '0 auto', paddingBottom: 60 }} className="animate-fade-in">
      {/* Page Title */}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 20, alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={{
            ...
            {['admin', 'recruiter', 'consultant'].map(role => (<button key={role} onClick={() => setActiveTab(role)} style={{
                flex: 1,
                padding: '9px 12px',
                borderRadius: 9,
                border: 'none',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {REQUIREMENTS_DATA[activeTab].map(req => (<div key={req.id} style={{
                background: 'var(--card)',
                border: '1px solid var(--border)',
                borderRadius: 14,
                padding: '16px 20px',
                ...
                marginTop: 10
                  ...
                  {req.fileLink && (<a href={req.fileLink} style={{
                    color: 'var(--accent)',
                    textDecoration: 'none',
                    fontWeight: 700,
                    display: 'inline-flex',
        ...
        ].map(([href, label]) => (<a key={href} href={href} style={{
                display: 'flex',
                alignItems: 'center',
                gap: 8,
                padding: '8px 12px',
