...
function LoginPage() {
    return (<main className="landing-page">
      ...
      <header className="landing-header">
        <link_1.default href="/" className="landing-logo-link">
          <div className="landing-logo-box">Pi</div>
          <span className="logo-text">PinIT Careers</span>
        </link_1.default>
        <link_1.default href="/signup" className="signup-nav-link">
          Create account →
        </link_1.default>
      </header>
      ...
      <div className="landing-main">
        ...
        ].map((prop, idx) => (<div className="prop-card" key={idx}>
      ...
      <footer className="landing-footer">
        ...
        <div className="footer-links">
          <link_1.default href="/privacy" className="footer-link">Privacy Policy</link_1.default>
          <link_1.default href="/terms" className="footer-link">Terms of Service</link_1.default>
        </div>
      </footer>
    </main>);
}
