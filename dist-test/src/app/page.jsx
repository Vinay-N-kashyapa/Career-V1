      ...
      <div style={{ background: 'var(--bg, #0f0f11)', minHeight: '100vh', position: 'relative', overflow: 'hidden' }}>
        ...
        <nav style={{ position: 'sticky', top: 0, zIndex: 50, borderBottom: '1px solid rgba(255,255,255,0.06)', background: 'rgba(15,15,17,0.85)', backdropFilter: 'blur(12px)' }}>
          <div className="landing" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 60 }}>
            <link_1.default href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              <link_1.default href="/login" style={{ padding: '7px 18px', borderRadius: 8, fontSize: 13, fontWeight: 600, color: 'rgba(255,255,255,0.7)', textDecoration: 'none', fontFamily: 'var(--font-display)', transition: 'color 0.2s' }} onMouseEnter={(e) => e.currentTarget.style.color = '#fff'} onMouseLeave={(e) => e.currentTarget.style.color = 'rgba(255,255,255,0.7)'}>Log in</link_1.default>
              <link_1.default href="/signup" className="btn-gradient" style={{ padding: '8px 20px', borderRadius: 8, fontSize: 13, fontWeight: 700, background: 'linear-gradient(135deg,#4f46e5,#7c3aed)', color: '#fff', textDecoration: 'none', fontFamily: 'var(--font-display)', boxShadow: '0 4px 12px rgba(79,70,229,0.3)' }}>Get started free</link_1.default>
            </div>
          </div>
        </nav>
        ...
        <section style={{ padding: '100px 0 80px', textAlign: 'center', position: 'relative', zIndex: 10 }}>
          <div className="landing">
            ...
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
              <link_1.default href="/signup" className="btn-gradient" style={{ padding: '14px 32px', borderRadius: 10, fontSize: 15, fontWeight: 700, background: 'linear-gradient(135deg,#4f46e5,#7c3aed)', color: '#fff', textDecoration: 'none', fontFamily: 'var(--font-display)', boxShadow: '0 6px 24px rgba(79,70,229,0.4)', letterSpacing: '-0.3px' }}>
                Start free — no pin card
              </link_1.default>
              <link_1.default href="/login" className="btn-outline" style={{ padding: '14px 28px', borderRadius: 10, fontSize: 15, fontWeight: 600, border: '1px solid rgba(255,255,255,0.12)', color: 'rgba(255,255,255,0.85)', textDecoration: 'none', fontFamily: 'var(--font-display)', background: 'rgba(255,255,255,0.03)' }}>
                Sign in →
              </link_1.default>
            </div>
          </div>
        ...
        <section style={{ padding: '20px 0 60px' }}>
          <div className="landing">
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(140px,1fr))', gap: 1, background: 'rgba(255,255,255,0.06)', borderRadius: 16, overflow: 'hidden', border: '1px solid rgba(255,255,255,0.06)' }}>
              {STATS.map((s, i) => (<div key={i} style={{ padding: '22px 20px', textAlign: 'center', background: 'rgba(15,15,17,0.9)' }}>
        ...
        <section style={{ padding: '60px 0' }}>
          <div className="landing">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(280px,1fr))', gap: 24 }}>
              {HOW_IT_WORKS.map((step, i) => (<div key={i} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 28, position: 'relative' }}>
                  ...
                  {i < HOW_IT_WORKS.length - 1 && (<div style={{ position: 'absolute', right: -14, top: '50%', transform: 'translateY(-50%)', fontSize: 20, color: 'rgba(255,255,255,0.2)', display: 'none' }}>→</div>)}
                </div>))}
            </div>
          </div>
        </section>
        ...
        <section style={{ padding: '60px 0' }}>
          <div className="landing">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(320px,1fr))', gap: 16 }}>
              {FEATURES.map((f, i) => (<link_1.default key={i} href={f.href} style={{ textDecoration: 'none' }}>
        ...
        <section style={{ padding: '60px 0' }}>
          <div className="landing">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: 20 }}>
              {TESTIMONIALS.map((t, i) => (<div key={i} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 16, padding: 24 }}>
          ...
          <div className="landing">
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(260px,1fr))', gap: 16, maxWidth: 860, margin: '0 auto' }}>
              ...
              <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 20, padding: '28px 24px' }}>
                ...
                {['3 AI interviews/month', '2 resume uploads', '30 mission evaluations', 'Full Career DNA profile'].map((f, i) => (<div key={i} style={{ display: 'flex', gap: 10, marginBottom: 10, fontSize: 13, color: 'rgba(255,255,255,0.65)' }}>
                    <span style={{ color: '#4f46e5' }}>✓</span>{f}
                  </div>))}
                <link_1.default href="/signup" style={{ display: 'block', marginTop: 20, padding: '11px', borderRadius: 9, background: 'rgba(79,70,229,0.15)', border: '1px solid rgba(79,70,229,0.3)', color: '#818cf8', textAlign: 'center', textDecoration: 'none', fontWeight: 700, fontSize: 14, fontFamily: 'var(--font-display)' }}>
                  Get started free
                </link_1.default>
              </div>
              ...
              <div style={{ background: 'linear-gradient(135deg,rgba(79,70,229,0.15),rgba(124,58,237,0.15))', border: '2px solid rgba(79,70,229,0.5)', borderRadius: 20, padding: '28px 24px', position: 'relative', overflow: 'hidden' }}>
                ...
                {['Unlimited AI interviews', 'Unlimited resume uploads', 'Unlimited missions & exams', 'AI Resume Improve', 'Full vault access', 'All avatar modes', 'Priority support'].map((f, i) => (<div key={i} style={{ display: 'flex', gap: 10, marginBottom: 10, fontSize: 13, color: 'rgba(255,255,255,0.75)' }}>
                    <span style={{ color: '#818cf8' }}>✓</span>{f}
                  </div>))}
                <link_1.default href="/signup" style={{ display: 'block', marginTop: 20, padding: '11px', borderRadius: 9, background: 'linear-gradient(135deg,#4f46e5,#7c3aed)', color: '#fff', textAlign: 'center', textDecoration: 'none', fontWeight: 700, fontSize: 14, fontFamily: 'var(--font-display)', boxShadow: '0 4px 16px rgba(79,70,229,0.4)' }}>
                  Start Pro free trial
                </link_1.default>
              </div>
            </div>
            <div style={{ textAlign: 'center', marginTop: 28, fontSize: 13, color: 'rgba(255,255,255,0.4)' }}>
              Institutions and placement cells — <link_1.default href="/signup" style={{ color: '#818cf8' }}>contact us</link_1.default> for bulk pricing (₹49,999/year/college)
            </div>
          </div>
        </section>
          ...
          <div className="landing">
            <div style={{ background: 'linear-gradient(135deg,rgba(79,70,229,0.12),rgba(6,182,212,0.08))', border: '1px solid rgba(79,70,229,0.2)', borderRadius: 24, padding: '60px 40px' }}>
              ...
              <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 16 }}>
                <link_1.default href="/signup" style={{ padding: '15px 36px', borderRadius: 10, fontSize: 15, fontWeight: 700, background: 'linear-gradient(135deg,#4f46e5,#7c3aed)', color: '#fff', textDecoration: 'none', fontFamily: 'var(--font-display)', boxShadow: '0 8px 28px rgba(79,70,229,0.5)', letterSpacing: '-0.3px' }}>
                  Sign up free →
                </link_1.default>
              </div>
        ...
        <footer style={{ borderTop: '1px solid rgba(255,255,255,0.06)', padding: '32px 0' }}>
          <div className="landing" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
            ...
            <div style={{ display: 'flex', gap: 24 }}>
              {[['Privacy', '/privacy'], ['Terms', '/terms'], ['Contact', '/contact']].map(([l, h]) => (<link_1.default key={l} href={h} style={{ fontSize: 12, color: 'rgba(255,255,255,0.35)', textDecoration: 'none' }}>{l}</link_1.default>))}
            </div>
          </div>
        </footer>
      </div>
