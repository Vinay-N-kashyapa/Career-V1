...
exports.DEFAULT_PERSONA = exports.MEMORY_TYPES = void 0;
exports.usePersonalAvatarMemory = usePersonalAvatarMemory;
...
exports.DEFAULT_PERSONA = DEFAULT_PERSONA;
function usePersonalAvatarMemory(userId) {
    const memoryRef = (0, react_1.useRef)(new Map());
    const conversationHistoryRef = (0, react_1.useRef)([]);
    const personaRef = (0, react_1.useRef)({ ...DEFAULT_PERSONA });
    const relationshipStateRef = (0, react_1.useRef)({
        trustLevel: 0.5,
    ...
    const initializePersona = (0, react_1.useCallback)((customPersona = {}) => {
        const newPersona = {
            ...DEFAULT_PERSONA,
            ...customPersona,
            userId,
    ...
    // Store memory
    const storeMemory = (0, react_1.useCallback)((type, data, metadata = {}) => {
        const memory = {
    ...
    const storePersonalInfo = (0, react_1.useCallback)((info) => {
    ...
    // Store conversation
    const storeConversation = (0, react_1.useCallback)((userMessage, avatarResponse, context = {}) => {
        const conversation = {
            userMessage,
            avatarResponse,
            timestamp: Date.now(),
    ...
    const storePreferences = (0, react_1.useCallback)((preferences) => {
        return storeMemory(MEMORY_TYPES.PREFERENCES, preferences, { importance: 0.7 });
    }, [storeMemory]);
    // Build relationship context
    const updateRelationshipState = (0, react_1.useCallback)((context) => {
        if (!context)
            return;
    ...
    const getRelevantMemories = (0, react_1.useCallback)((query, limit = 5) => {
        const allMemories = [];
    ...
    const getConversationContext = (0, react_1.useCallback)((depth = 5) => {
        return conversationHistoryRef.current.slice(-depth);
    }, []);
    // Generate response with memory
    const generateMemoryAwareResponse = (0, react_1.useCallback)((userInput, context = {}) => {
    ...
    // Get persona
    const getPersona = (0, react_1.useCallback)(() => personaRef.current, []);
    // Update persona traits
    const updatePersonaTraits = (0, react_1.useCallback)((traits) => {
        personaRef.current = {
            ...personaRef.current,
            ...traits,
        };
    ...
    const getRelationshipState = (0, react_1.useCallback)(() => ({
        ...relationshipStateRef.current,
    }), []);
    // Export memory to file
    const exportMemory = (0, react_1.useCallback)(() => {
        const exportData = {
            userId,
    ...
    const importMemory = (0, react_1.useCallback)((importData) => {
    ...
    // Clear all memory
    const clearMemory = (0, react_1.useCallback)((type = null) => {
        if (type) {
