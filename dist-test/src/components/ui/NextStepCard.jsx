...
exports.default = NextStepCard;
const link_1 = __importDefault(require("next/link"));
function NextStepCard({ title, description, href, ctaLabel = 'Continue →', icon = '✦', color = 'var(--accent)', eyebrow = 'Next step', }) {
    return (<link_1.default href={href} style={{
            display: 'flex',
            alignItems: 'center',
            gap: 16,
            padding: '16px 20px',
